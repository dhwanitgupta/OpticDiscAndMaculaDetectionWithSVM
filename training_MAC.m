...
for i = 1:130
    ...
    tanVal = double(double((x_od-x_mac))/double((y_od-y_mac)));
    myAngle = atan(tanVal)*180/pi;
    feature1 = sum(sum(cg1(x_mac-29:x_mac+30, y_mac-29:y_mac+30))) / avg;     
    feature2 = mean(mean(cg1(x_mac-29:x_mac+30, y_mac-29:y_mac+30))) - mean(mean(cg1(x_mac-49:x_mac+50, y_mac-49:y_mac+50))) /avg;
    feature3 = sum(sum(vessmac(x_mac-29:x_mac+30,y_mac-29:y_mac+30))) / avg_ves;
    feature4 = myAngle;
    
    feature = [feature1 feature2 feature3 feature4];
        
    feature_MAC = [ feature_MAC ; feature ];
